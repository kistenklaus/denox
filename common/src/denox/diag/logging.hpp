...
#define DENOX_TRACE(...)                                                       \
  ::denox::diag::denox_logger().trace(__VA_ARGS__)
#define DENOX_DEBUG(...)                                                       \
  ::denox::diag::denox_logger().debug(__VA_ARGS__)
#define DENOX_INFO(...)                                                        \
  ::denox::diag::denox_logger().info(__VA_ARGS__)
#define DENOX_WARN(...)                                                        \
  ::denox::diag::denox_logger().warn(__VA_ARGS__)
#define DENOX_ERROR(...)                                                       \
  ::denox::diag::denox_logger().error(__VA_ARGS__)
...
#define DENOX_INFO_RAW(...)                                                    \
  ::denox::diag::denox_raw_logger().info(__VA_ARGS__)
#define DENOX_WARN_RAW(...)                                                    \
  ::denox::diag::denox_raw_logger().warn(__VA_ARGS__)
