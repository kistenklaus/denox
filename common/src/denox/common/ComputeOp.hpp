...
#include "denox/common/ops/ComputeOpPool.hpp"
#include "denox/common/ops/ComputeOpSlice.hpp"
#include "denox/common/ops/ComputeOpUpsample.hpp"
#include <fmt/core.h>
#include <variant>
...
template <> struct fmt::formatter<denox::ComputeOp> {
  constexpr auto parse(fmt::format_parse_context &ctx) { return ctx.begin(); }

  template <typename FormatContext>
  auto format(const denox::ComputeOp &op, FormatContext &ctx) const {
    using denox::ComputeOpKind;
