...
static py::dict generatePipeline(py::object obj) {
  try {
    ...
    //   }
    //   if (type == "input") {
    //     unsigned int inputChannels = 0; // TODO
    //
    //     layers.push_back(pyvk::CNNLayerDescription::input(
    //         name, pyvk::ImageShape{
    //                   .width = {},
    //                   .height = {},
    ...
    //         name, kernelShape, strideShape, paddingShape, std::move(weights)));
    ...
    //           name, pyvk::ActivationFunction::Relu));
    //     } else {
    //       throw std::runtime_error(
    ...
    //
    //     layers.push_back(
    //         pyvk::CNNLayerDescription::maxPool(name, kernelShape, strideShape));
    ...
    //     }
    //
    //     layers.push_back(pyvk::CNNLayerDescription::upsample(name, filterMode));
    //   } else if (type == "concat") {
    //
    //   } else if (type == "output") {
    //
