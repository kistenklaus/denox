#include "./FilterDeviceTensor.hpp"

namespace vkcnn::runtime {

void FilterDeviceTensor::Download::complete(FilterHostTensorView hostTensor) {
...
void FilterDeviceTensor::upload(const ::merian::CommandBufferHandle &cmd,
...
FilterDeviceTensor::use(const ::merian::CommandBufferHandle &cmd,
...
FilterDeviceTensor::Download
FilterDeviceTensor::download(const ::merian::CommandBufferHandle &cmd) {
  if (m_store->stageManager == nullptr) {
