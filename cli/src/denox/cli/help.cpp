...
"\n"
"   --min-samples,samples           minimum amount of samples per database entry\n"
"   --max-samples           maximum amount of samples per database entry\n"
"   --batch-size            amount of dispatches submitted together.\n"
